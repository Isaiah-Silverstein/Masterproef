...
Stim_activation[0,:] = [0,1]    #square
Stim_activation[1,:] = [1,0]    #circle
...
for trial in range(n_trials):
    ...
    resp[trial] = list(Rate[nStim:nUnits]).index(max(Rate[nStim:nUnits]))
...
for trial in range(n_trials):
    ...
    fig.suptitle('Phase code units of input and response nodes')
